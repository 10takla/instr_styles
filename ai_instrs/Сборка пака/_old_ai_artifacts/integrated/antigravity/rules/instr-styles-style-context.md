...
1. Determine the composition and hierarchy of task stages according to [instr-styles:stages](slashCommand;instr-styles:stages).
2. Choose the appropriate stage content model (simple or structured) according to [instr-styles:content-models](slashCommand;instr-styles:content-models).
3. Format sections of each stage and transferred data types according to [instr-styles:content-sections](slashCommand;instr-styles:content-sections).
