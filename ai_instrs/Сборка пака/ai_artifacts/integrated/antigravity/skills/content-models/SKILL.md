---
name: "instr-styles:content-models"
description: ""
---
...
- In the `<Sections>` block, place inputs, algorithm, instructions, or outputs according to [instr-styles:content-sections](slashCommand;instr-styles:content-sections).
...
- **Implementation Instructions:** contains concrete steps, rules, and action sections formatted according to [instr-styles:content-sections](slashCommand;instr-styles:content-sections).
...
3. Format the execution part: apply sections from [instr-styles:content-sections](slashCommand;instr-styles:content-sections). In the structured model, place them under the `### Implementation Instructions` heading.
