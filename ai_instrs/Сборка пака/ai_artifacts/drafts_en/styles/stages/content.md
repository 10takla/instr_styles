...
- Form `<Content>` in accordance with models from @draft(content-models) and sections from @draft(content-sections).
...
4. Fill the body of each stage according to @draft(content-models) and @draft(content-sections).
